...
# Images
P1 = './Pygame-Project-2024/Crown/images/nobgmonkey.png'
P1G = './Crown/images/gorilla.png'

P2 = './Pygame-Project-2024/Crown/images/nobgmonkey.png'
P2G = './Pygame-Project-2024/Crown/images/gorilla.png'

P3 = './Pygame-Project-2024/Crown/images/nobgmonkey.png'
P3G = './Pygame-Project-2024/Crown/images/gorilla.png'

BANANA = './Pygame-Project-2024/Crown/images/banana.png'

BACKGROUND = './Pygame-Project-2024/Crown/images/junglebg.webp'
RESULT_BG = './Pygame-Project-2024/Crown/images/junglebg.webp'

# Define images that hold a crown
CROWN_LIST = [P1G, P2G, P3G]
...
# Sounds for game
pygame.mixer.init()
background_song = pygame.mixer.Sound("./Pygame-Project-2024/Crown/sounds/monkeys.mp3")

# Hit sounds
hit_sound = pygame.mixer.Sound("./Pygame-Project-2024/Crown/sounds/hit_sound.mp3")
crown_sound = pygame.mixer.Sound("./Pygame-Project-2024/Crown/sounds/crown_sound.mp3")
...
class Crown(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load(BANANA)
        self.image = pygame.transform.scale(self.image, (100, 100))
        self.rect = self.image.get_rect()
...
def main():
    ...
    result_bg = pygame.image.load(RESULT_BG)

    # Play background song
    pygame.mixer.Sound.play(background_song)

    # Title of game
    pygame.display.set_caption("King of the Monkeys")

    # Create the players and crown
    player = Player(P1, P1G)
    player2 = Player(P2, P2G)
    player3 = Player(P3, P3G)
    crown = Crown()
